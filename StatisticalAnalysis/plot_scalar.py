...
def create_plot_conf(df, DATA, log_level):
    ...
    for df_type in life_time, life_time_u1, life_time_u2, queue_length_u1, queue_length_u2:
        # logging.debug(df_type.iloc[0]['Name'])
...
if __name__ == "__main__":
    ...
    df_data_lifetime = create_csv_lifetime('./data/data_results', logging.DEBUG)
    create_plot_conf(df_data_mean, './charts/charts_results', logging.INFO)
    create_plot_lifetime(df_data_lifetime, './charts/charts_results', logging.DEBUG)
    ...
    create_plot_conf(df_data_lifetime_no_transient, './charts/charts_results_no_transient', logging.INFO)
    create_plot_lifetime(df_data_lifetime, './charts/charts_results_no_transient', logging.DEBUG)
