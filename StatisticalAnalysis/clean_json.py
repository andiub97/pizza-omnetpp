...
for results_dir in ['data_results_json', 'data_results_no_transient_json', 'data_single-results_json',
                    'data_single-results_no_transient_json']:  # os.listdir(DATA_VEC_DIR):
